...
shp = gpd.read_file(os.path.join(home, "Data", "Catchments", "Headwater", "headwater_catchments_perm_forest_32617.shp"))
with fiona.open(shp_file) as src:
        features = list(src)
print("shapes done!")

tifs = [os.path.join(home, "Data", "Topography", "Slope", "slope_10m_sbr.tif"),
        os.path.join(home, "Data", "Topography", "Aspect", "aspect_10m_sbr.tif")]
colnames = ["Slope", "Aspect"]
